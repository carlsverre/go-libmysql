...
// includes all error codes emitted by MemSQL
const (
	ER_ERROR_FIRST                                            = 1000
	ER_HASHCHK                                                = 1000
	ER_NISAMCHK                                               = 1001
	...
	ER_MEMSQL_FAILED_CODE_GEN                                 = 1705
	ER_MEMSQL_FEATURE_LOCKDOWN                                = 1706
	ER_MEMSQL_FAILED_PARAMETERIZE                             = 1707
	ER_MEMSQL_AGG_NYA                                         = 1708
	ER_MEMSQL_UNUSED_1                                        = 1709
	ER_MEMSQL_HASH_INDEX_NOT_UNIQUE                           = 1710
	ER_MEMSQL_INDEX_NOT_SUPPORTED                             = 1711
	ER_MEMSQL_OOM                                             = 1712
	ER_MEMSQL_JOIN_NYA                                        = 1713
	ER_MEMSQL_MAX_CON_TOO_HIGH                                = 1714
	ER_MEMSQL_SYNTAX_CHECK_OK                                 = 1715
	ER_MEMSQL_NOT_ALLOWED                                     = 1716
	ER_MEMSQL_FEATURE_DISABLED                                = 1717
	ER_MEMSQL_REPL_DB_CREATE_OR_DROP                          = 1718
	ER_MEMSQL_WRITE_QUERY_DURING_ALTER_TABLE                  = 1719
	ER_TABLE_MEMORY_LIMIT                                     = 1720
	ER_SET_MEMORY_LIMIT                                       = 1721
	ER_MEMSQL_INVALID_BUCKET_COUNT                            = 1722
	ER_MEMSQL_BUCKET_COUNT_WITHOUT_HASH                       = 1723
	ER_SET_MAX_MEMORY_LIMIT                                   = 1724
	ER_MEMSQL_USERS_TABLE                                     = 1725
	ER_CREATE_TABLE_MEMSQL                                    = 1726
	ER_DEV_EDITION_MEM_LIMIT                                  = 1727
	ER_MEMSQL_SYNC_ERROR                                      = 1728
	ER_LOADING_SO                                             = 1729
	ER_DB_NOT_ONLINE                                          = 1730
	ER_DB_NOT_RECOVERED                                       = 1731
	ER_INVALID_STATE                                          = 1732
	ER_UNRECOVERABLE                                          = 1733
	ER_DURABILITY_DISABLED                                    = 1734
	ER_CANNOT_CONNECT_TO_LEAF                                 = 1735
	ER_DISTRIBUTED_NOT_AGGREGATOR                             = 1736
	ER_DISTRIBUTED_LEAF_EXISTS                                = 1737
	ER_DISTRIBUTED_LEAF_DOESNT_EXIST                          = 1738
	ER_DISTRIBUTED_LEAF_CANT_CREATE_DB                        = 1739
	ER_DISTRIBUTED_LEAF_INVALID_RANGE                         = 1740
	ER_DISTRIBUTED_QUERY_SHARDED_TABLE_FROM_LEAF              = 1741
	ER_DISTRIBUTED_REPLICATE_REFERENCE_DATABASE_FAILED        = 1742
	ER_TOO_MANY_REPLICATION_TARGETS                           = 1743
	ER_MEMSQL_UNIQUE_KEY_SHARD_KEY                            = 1744
	ER_MEMSQL_UNMAPPED_PARTITION                              = 1745
	ER_DISTRIBUTED_UNCLASSIFIED_ERROR                         = 1746
	ER_DISTRIBUTED_NO_LEAVES                                  = 1747
	ER_DISTRIBUTED_NO_LEAVES_CREATE_DATABASE                  = 1748
	ER_DISTRIBUTED_FEATURE_LOCKDOWN                           = 1749
	ER_DISTRIBUTED_PARTITIONS_POWER_OF_TWO                    = 1750
	ER_DISTRIBUTED_AMBIGUOUS_PARTITION_KEY                    = 1751
	ER_DISTRIBUTED_NOT_MASTER                                 = 1752
	ER_DISTRIBUTED_MASTER                                     = 1753
	ER_DISTRIBUTED_UNKNOWN_AGGREGATOR_COMMAND                 = 1754
	ER_DISTRIBUTED_DUMMY3                                     = 1755
	ER_DISTRIBUTED_BIGINT_AUTO_INCREMENT                      = 1756
	ER_DISTRIBUTED_TABLE_NOT_SHARDED                          = 1757
	ER_DISTRIBUTED_LAST_LEAF                                  = 1758
	ER_DISTRIBUTED_REFERENCE_TABLES_ON_SINGLE_BOX             = 1759
	ER_CANNOT_CREATE_REFERENCE_TABLES_ON_LEAF                 = 1760
	ER_DISTRIBUTED_MASTER_IS_ALIVE                            = 1761
	ER_REPL_MEMSQL_DB                                         = 1762
	ER_REPL_ONLINE_DB                                         = 1763
	ER_UNUSED_ERROR_MESSAGE                                   = 1764
	ER_TABLE_LOCK_FAILURE                                     = 1765
	ER_DB_QUERY_OFFLINE                                       = 1766
	ER_DB_QUERY_PROVISIONING                                  = 1767
	ER_DB_QUERY_CORRUPTED                                     = 1768
	ER_REPL_ALREADY_REPLICATING                               = 1769
	ER_DISTRIBUTED_QUERY_PARALLELISM_IGNORED                  = 1770
	ER_DISTRIBUTED_LEAF_STATUS_UNRECOGNIZED_FIELD             = 1771
	ER_DISTRIBUTED_PARTITION_MOVE_FAILED                      = 1772
	ER_DISTRIBUTED_PARTITION_ORDINAL_TOO_BIG                  = 1773
	ER_DISTRIBUTED_INSTANCE_ON_NODE_ALREADY_PRESENT           = 1774
	ER_DISTRIBUTED_CHECK_PARTITIONS_FAILURE                   = 1775
	ER_DISTRIBUTED_INSTANCE_IS_MASTER                         = 1776
	ER_DISTRIBUTED_PARTITION_HAS_NO_INSTANCES                 = 1777
	ER_DISTRIBUTED_PARTITION_NAME_TOO_LONG                    = 1778
	ER_DISTRIBUTED_INVALID_GROUP_ID                           = 1779
	ER_DISTRIBUTED_LEAF_LOST_PAIR                             = 1780
	ER_DISTRIBUTED_LEAF_HAS_NO_PAIR_REORGANIZE                = 1781
	ER_DISTRIBUTED_GROUPS_UNBALANCED                          = 1782
	ER_DISTRIBUTED_INVALID_REDUNDANCY_LEVEL                   = 1783
	ER_DISTRIBUTED_GROUP_NOT_EMPTY                            = 1784
	ER_DISTRIBUTED_REBALANCE_WARNING                          = 1785
	ER_DISTRIBUTED_LEAF_COUNT_LIMIT                           = 1786
	ER_DISTRIBUTED_CONCURRENT_NODE_REMOVAL                    = 1787
	ER_DROP_DURING_RESTORE                                    = 1788
	ER_INVALID_BACKUP_PATH                                    = 1789
	ER_INVALID_RESTORE_PATH                                   = 1790
	ER_RESTORE_OUT_OF_DISK                                    = 1791
	ER_BACKUP_IO_ERROR                                        = 1792
	ER_CANNOT_CONTINUE_REPLICATING                            = 1793
	ER_UNKNOWN_EXPLAIN_FORMAT                                 = 1794
	ER_DISTRIBUTED_DATABASE_NOT_SHARDED                       = 1795
	ER_DISTRIBUTED_CONCURRENT_REBALANCE                       = 1796
	ER_RECOVERY_IN_PROGRESS                                   = 1797
	ER_DISTRIBUTED_AGGREGATOR_LEAF                            = 1798
	ER_DISTRIBUTED_MASTER_AGGREGATOR_AS_LEAF                  = 1799
	ER_DISTRIBUTED_MULTIPLE_FOREIGN_KEYS                      = 1800
	ER_DISTRIBUTED_FOREIGN_KEY_SHARD_KEY                      = 1801
	ER_DISTRIBUTED_LEAF_IS_OFFLINE                            = 1802
	ER_DISTRIBUTED_LEAF_ALREADY_ONLINE                        = 1803
	ER_DISTRIBUTED_LEAF_NOT_ONLINE                            = 1804
	ER_MULTIPLE_SHARD_KEYS                                    = 1805
	ER_CONCURRENT_LOAD_FILE                                   = 1806
	ER_DISTRIBUTED_USER_PERMISSIONS                           = 1807
	ER_DISTRIBUTED_LEAF_USER_PERMISSIONS                      = 1808
	ER_DISTRIBUTED_OUT_OF_CAPACITY                            = 1809
	ER_UNUSED                                                 = 1810
	ER_DISTRIBUTED_ATTACH_LEAF_FAILED                         = 1811
	ER_MEMSQL_READ_QUERY_DURING_ALTER_TABLE                   = 1812
	ER_MEMSQL_ONLINE_ALTER_IMPOSSIBLE                         = 1813
	ER_DISTRIBUTED_USER_BAD_HOST                              = 1814
	ER_DISTRIBUTED_USER_DELETE                                = 1815
	ER_FAILED_FOREIGN_KEY_CONSTRAINT                          = 1816
	ER_FOREIGN_KEY_INDEX                                      = 1817
	ER_FOREIGN_KEY_TYPE_MISMATCH                              = 1818
	ER_FOREIGN_KEY_GENERIC_ERROR                              = 1819
	ER_MEMSQL_COMPUTED_DEPEND_ON_NON_EXISTING                 = 1820
	ER_MEMSQL_COMPUTED_DEPENDENCY_LOOP                        = 1821
	ER_MEMSQL_COMPUTED_INSERT                                 = 1822
	ER_MEMSQL_COMPUTED_UPDATE                                 = 1823
	ER_MEMSQL_COMPUTED_DEPEND_ON_TIME                         = 1824
	ER_MEMSQL_COMPUTED_IS_TIMESTAMP                           = 1825
	ER_MEMSQL_COMPUTED_EXPR_TOO_LONG                          = 1826
	ER_MEMSQL_INVALID_LEAF_SIGNAL                             = 1827
